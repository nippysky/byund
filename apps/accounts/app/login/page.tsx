  ...
  return (
    <div style={{ width: "100%", maxWidth: 400 }}>
      ...
      {IS_DEV && DEV_EMAIL && (
        ...
        >
          <Zap size={13} />
          Dev: autofill admin credentials
        </button>
      )}
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <button
            ...
            style={{
              ...
              boxShadow: "0 4px 24px rgba(114,96,251,0.38)", fontFamily: "inherit",
              marginTop: 4,
            }}
          >
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(114,96,251,0.14) 0%, transparent 65%)",
        pointerEvents: "none",
      }} />
      {/* Grid */}
      <div style={{
    ...
    <div style={{ minHeight: "100dvh", display: "flex", background: "var(--bg)", color: "var(--text-1)" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", position: "relative" }}>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "16px 28px 48px" }}>
          <Suspense fallback={
            <div style={{ width: 400, height: 380, background: "var(--surface-1)", borderRadius: 20, border: "1.5px solid var(--border-med)", animation: "pulse 2s infinite" }} />
          }>
            <LoginForm />
          </Suspense>
        </div>
      ...
      <style>{`
        @media (min-width: 768px) {
          .acc-left { display: flex !important; }
          .acc-mobile-logo { display: none !important; }
        }
