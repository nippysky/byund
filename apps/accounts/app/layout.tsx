...
export const metadata: Metadata = {
  title: { default: "BYUND Accounts", template: "%s | BYUND Accounts" },
  description: "Sign in to your BYUND account — one identity across all BYUND products.",
};
    ...
    <html lang="en" data-theme="dark" suppressHydrationWarning>
      ...
      <body className={publicSans.variable} style={{ fontFamily: "var(--font-public-sans), system-ui, sans-serif" }}>
        ...
        <Toaster
          ...
          toastOptions={{
            style: { background: "var(--surface-1)", border: "1px solid var(--border-med)", color: "var(--text-1)" },
          }}
        />
      </body>
    </html>
