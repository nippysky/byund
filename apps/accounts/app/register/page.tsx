...
function RegisterForm() {
  ...
  const fields = [
    { key: "name"          as const, label: "Full Name",      Icon: User,      type: "text",     placeholder: "Your Name" },
    ...
    { key: "workspaceName" as const, label: "Workspace Name", Icon: Building2, type: "text",     placeholder: "My Company" },
  ];
      ...
      <div style={{ textAlign: "center", marginBottom: 30 }}>
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 18 }}>
          <svg width={44} height={44} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="200" height="200" rx="44" fill="url(#acc-reg-g)" />
            <defs>
              <linearGradient id="acc-reg-g" x1="0" y1="0" x2="200" y2="200" gradientUnits="userSpaceOnUse">
        ...
        <div style={{ fontSize: 9, fontWeight: 800, letterSpacing: "0.22em", color: "var(--brand)", marginBottom: 4 }}>BYUND</div>
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px 24px 56px", position: "relative", zIndex: 1 }}>
        <Suspense fallback={<div style={{ width: 440, height: 460, background: "var(--surface-1)", borderRadius: 18, border: "1px solid var(--border-med)" }} />}>
          <RegisterForm />
        </Suspense>
      </div>
    </div>
