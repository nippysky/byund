    ...
    <div className="relative" ref={wrapRef}>
      ...
      >
        ...
        <div className="hidden min-w-0 flex-col text-left sm:flex">
          <span className="max-w-45 truncate text-[12px] font-medium text-foreground">{name}</span>
          {email ? <span className="max-w-45 truncate text-[11px] text-muted">{email}</span> : null}
        </div>
      ...
      {open && (
        ...
        >
          <div className="px-4 py-3">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted">Account</p>
